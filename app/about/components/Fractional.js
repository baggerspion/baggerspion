...
export default function Fractional() {
    return (
        <div className="flex flex-col-reverse md:flex-row">
            ...
            <div className="flex flex-col min-h-[30rem] md:w-1/2 p-[3rem] md:p-[6rem] justify-center">
                <h2 className="text-leader pb-4">Fractional Engineering Leadership</h2>
                <p className="text-about">
                    Fractional Engineering Leadership is dedicated to guiding startups in key non-product areas of engineering, e.g. tooling, developer productivity, engineer career development. I focus on building a strong, efficient team culture and driving organizational success.
