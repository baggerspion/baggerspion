    ...
    return (
        <div className="flex flex-col">
            <div className="flex flex-col md:flex-row">
                <div className="bg-white p-[6rem] md:w-1/2 flex flex-col justify-center h-[30rem]">
                ...
                <div className="md:w-1/2 p-[6rem] relative h-[30rem]">
            ...
            <div className="flex flex-col md:flex-row-reverse">
                <div className="bg-white md:w-1/2 p-[6rem] flex flex-col justify-center h-[30rem]">
