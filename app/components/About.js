    ...
    return (
        <section className="flex flex-col">
            <div className="flex flex-col md:flex-row">
                <div className="h-[30rem] w-full md:w-1/2 bg-[url('/alexander-andrews-JYGnB9gTCls-unsplash.jpg')] bg-cover bg-center"></div>
                <div className="h-[30rem] w-full md:w-1/2 bg-white p-[3rem] md:p-[6rem] flex flex-col justify-center">
            ...
            <div className="flex flex-col md:flex-row-reverse">
                <div className="h-[30rem] w-full md:w-1/2 bg-[url('/paul-skorupskas-7KLa-xLbSXA-unsplash.jpg')] bg-cover bg-center"></div>
                <div className="h-[30rem] w-full md:w-1/2 bg-white p-[3rem] md:p-[6rem] flex flex-col justify-center">
            ...
            <div className="flex flex-col md:flex-row">
                <div className="h-[30rem] w-full md:w-1/2 bg-[url('/priscilla-du-preez-aPa843frIzI-unsplash.jpg')] bg-cover bg-center"></div>
                <div className="h-[30rem] w-full md:w-1/2 bg-white p-[3rem] md:p-[6rem] flex flex-col justify-center">
